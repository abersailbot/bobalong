...
// XBee
SoftwareSerial xbee(_RX_1, _TX_1);
...
void UpdateGPS() {
  ...
  Serial.print("GPS: "); Serial.print(boat.date_time.time);
...
void LogData() {
  ...
  // GPS Heading
  Serial1.print("gpshead="); Serial1.print(boat.course.bearing); Serial1.print(" ");
  // Speed
  ...
  // Output to the xbee
  // Time
  xbee.print("time="); xbee.print(now()); xbee.print(" ");
  // Boat Heading
  xbee.print("bhead="); xbee.print(boat.bearing.heading); xbee.print(" ");
  // GPS Heading
  xbee.print("gpshead="); xbee.print(boat.course.bearing); xbee.print(" ");
  // Speed
  xbee.print("knots="); xbee.print(boat.course.speed); xbee.print(" ");
  // Boat Wind Dir
  xbee.print("wind="); xbee.print(boat.wind.direction); xbee.print(" ");
  // Wind speed
  xbee.print("windSpd="); xbee.print(boat.wind.speed); xbee.print(" ");
  // Lat
  xbee.print("lat="); xbee.print(boat.position.latitude, 5); xbee.print(" ");
  // Long
  xbee.print("lon="); xbee.print(boat.position.longitude, 5); xbee.println(" ");
}
